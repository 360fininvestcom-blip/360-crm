...
export function StatsGrid() {
    ...
    const stats = useMemo(() => {
        const connectRate = analytics ? (analytics.calls.total > 0 ? (analytics.calls.connected / analytics.calls.total) * 100 : 0) : 0;

        return [
            {
                title: "Connect Rate (7d)",
                rawValue: connectRate,
                prefix: "",
                suffix: "%",
            ...
            {
                title: "Active Deals",
                rawValue: analytics?.deals.activeCount || 0,
                prefix: "",
                suffix: "",
            ...
            },
            {
                ...
                rawValue: analytics?.deals.weightedValue || 0,
                prefix: "$",
                suffix: "",
            ...
            },
            {
                ...
                rawValue: analytics?.deals.wonValue || 0,
                prefix: "$",
                suffix: "",
